...
/**
   A node in a graph.
*/
public interface InterfaceNoeud extends Serializable, Cloneable
{
   /**
      Draw the node.
   ...
   */
   boolean addNode(InterfaceNoeud n, Point2D p);
   ...
   */
   void removeNode(Graph g, InterfaceNoeud n);
   ...
   */
   ...
   /**
      ...
      has no parent
   */
   void setParent(InterfaceNoeud node);
   ...
   */
   void addChild(int index, InterfaceNoeud node);

   /**
      Removes a child node.
      @param node the child to remove.
   */
   void removeChild(InterfaceNoeud node);
